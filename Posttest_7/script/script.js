document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('more-mesoamerica').addEventListener('click', function() {
        showModal(
            ...
            <p>Peradaban Mesoamerika mengalami penurunan yang signifikan setelah kedatangan penjajah Spanyol. Suku Aztec mengalami kehancuran setelah penaklukan oleh Hernán Cortés pada tahun 1521. Jumlah penduduk asli menurun drastis akibat penyakit yang dibawa oleh orang Eropa, perbudakan, dan perang.</p>
            <p>Peradaban Maya juga mengalami kemunduran setelah kedatangan Spanyol. Meskipun beberapa kota Maya telah ditinggalkan sebelum kedatangan orang Eropa, banyak pusat kota Maya yang masih aktif akhirnya jatuh ke tangan penjajah Spanyol pada abad ke-16 dan 17. Pengaruh budaya dan agama Spanyol secara bertahap menggantikan tradisi asli Maya.</p>
            <p>Namun, warisan peradaban Mesoamerika tidak sepenuhnya hilang. Beberapa aspek budaya, bahasa, dan praktik tradisional masih bertahan hingga saat ini, terutama di komunitas pribumi. Misalnya, banyak bahasa asli Mesoamerika masih digunakan, teknik pertanian kuno masih dipraktikkan, dan pengetahuan obat tradisional masih dilestarikan.</p>
            <p>Meskipun peradaban Mesoamerika mengalami kehancuran dan transformasi besar-besaran setelah penaklukan Spanyol, elemen-elemen budayanya masih hidup dan berkembang dalam bentuk yang telah beradaptasi. Warisan ini terus mempengaruhi identitas budaya dan sosial di Meksiko dan Amerika Tengah hingga hari ini.</p>
            `
        );
    });
